 ...
 <div class="footer">
    <div class="footer-content">
      ...
      <div class="footer-section about">
        <h1 class="logo-text"><span>Rod</span>Blogs</h1>
        <p>
        ...
        <div class="contact">
          <span><i class="fas fa-phone"></i> &nbsp; 437-982-2407</span>
          <span><i class="fas fa-envelope"></i> &nbsp; info@hello.com</span>
        </div>
        <div class="socials">
...
<!--          </button>-->
    ...
    <div class="footer-bottom">
      &copy; rodblogs.com | Designed by Rod Blogs
  </div>
  <!-- // footer -->